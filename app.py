...
# page title and logo i.e tabs title and logo
st.set_page_config(
    page_title="ChatBot_Clone",
    page_icon="🤖",
    layout="centered"
)
...
st.markdown("""
<div class="hero-card">
    <div class="brand-title">Local AI ChatBot Clone Using Ollama <span class="green">By Apuroop</span></div>
...
with st.sidebar:
    ...
    model = st.selectbox(
        "Choose Ollama Model",
        ["llama3.2", "moondream 2", "qwen2.5:3b"],
        index=0
    )
    ...
    "So pull required model")
    st.markdown("- Temperature slider is for creativity")
